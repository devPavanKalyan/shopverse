...
const DropdownMenu: React.FC<DropdownMenuProps> = ({ onClose }) => {
  ...
  return (
    <div
      className="absolute right-0 top-full w-72 bg-white shadow-lg rounded-3xl border border-gray-300 z-50"
      // Added a small mt-2 for spacing below button
    >
      <div className="absolute -top-2 right-4 w-0 h-0 border-l-8 border-r-8 border-b-8 border-transparent border-b-white"></div>

      <div className="p-8 max-w-md bg-white rounded-2xl shadow-lg font-sans text-gray-900">
        {isAuthenticated ? (
          <>
